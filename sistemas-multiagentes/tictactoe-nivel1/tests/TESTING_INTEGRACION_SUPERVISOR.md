...
| `test_json_invalido` | Tablero envía texto no JSON | 0 informes (el FSM no falla) |
| `test_esquema_invalido` | Tablero envía JSON sin campos obligatorios | 0 informes (validación de ontología rechaza) |
| `test_refuse` | Tablero responde REFUSE | 0 informes, FSM termina sin error |
