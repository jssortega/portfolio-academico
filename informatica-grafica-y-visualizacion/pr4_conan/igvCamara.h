...
{  private:
      ...
      GLdouble xwmin = 0    ///< Coordenada X mínima del frustum/proyección paralela
               , xwmax = 0   ///< Coordenada X máxima del frustum/proyección paralela
               , ywmin = 0   ///< Coordenada Y mínima del frustum/proyección paralela
               , ywmax = 0   ///< Coordenada Y máxima del frustum/proyección paralela
               ;

      // ventana de visión: parámetros proyección perspectiva
      GLdouble angulo = 0   ///< Ángulo de apertura (proyección perspectiva)
               , raspecto = 0   ///< Razón de aspecto (proyección perspectiva)
               ;

      // distancias de planos cercano y lejano
      GLdouble znear = 0    ///< Distancia de la cámara al plano Z near
               , zfar = 0 ///< Distancia de la cámara al plano Z far
               ;
      ...
      // vector arriba
      igvPunto3D V = { 0, 0, 0 };   ///< Vector que indica la vertical
