...
const GLdouble &igvCamara::getZnear() const {
    return znear;
}

const GLdouble &igvCamara::getZfar() const {
    return zfar;
}

void igvCamara::setZnear(const GLdouble &znear) {
    igvCamara::znear = znear;
}

void igvCamara::setZfar(const GLdouble &zfar) {
    igvCamara::zfar = zfar;
}
