...
public:
    ...
    Usuario* buscaUsuario(std::string email){Usuario usuario(email);Usuario* encontrado = _users.buscaRec(usuario); return encontrado;}
     ...
     * @return lista de usuarios con imagenes de la etiqueta de nombre @param etiqueta*/
