...
public:
    ...
    Imagen(string _id, string _nombre, unsigned int _tam, const Fecha &_fecha,int likes,std::deque<Etiqueta*> etiquetada);
    Imagen(string _id, string _nombre, unsigned int _tam, int dia,int mes,int anno,int likes);
